...
const StatusMenu = ({ toggleStatus }) => {
  ...
  return (
    <Fragment>
        <div className="absolute z-10 top-0 -right-52 -translate-x-1/2 transform translate-y-10 mt-3 px-2 w-[32rem] sm:w-screen sm:max-w-xl">
            <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
                <div className="relative bg-white px-8 pb-6 space-y-8">
                    <div className="flex py-6 border-b items-center justify-between">
                        ...
                        <div className="inline-flex items-center">
                            ...
                            <svg className="ml-3" width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M1.16663 7.00008H12.8333M12.8333 7.00008L6.99996 1.16675M12.8333 7.00008L6.99996 12.8334" stroke="#00AADD" stroke-width="1.67" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                        </div>
                    </div>
                    ...
                    <div class="mb-8 inline-flex items-center">
                        <a class="text-sm text-blue-tl" href="#">Need help? View our Documentation</a>
