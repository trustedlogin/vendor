...
const StatusMenu = ({ toggleStatus }) => {
  ...
  return (
    <Popover className="relative">
      ...
      <Popover.Panel className="absolute z-10 top-0 -right-52 -translate-x-1/2 transform translate-y-10 mt-3 px-2 w-[32rem] sm:-left-24 sm:w-screen sm:max-w-xl">
          ...
          <div className="relative bg-white px-8 pb-6 space-y-8">
            <div className="flex py-6 border-b items-center justify-between">
              <div className="flex items-center">
                <h2 className="leading-tight text-lg text-gray-900">Teams</h2>
              </div>
